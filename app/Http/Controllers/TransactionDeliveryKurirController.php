...
class TransactionDeliveryKurirController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.deliverykuriri.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $merchant =  $merchantService->editTransactionDeliveryCourier($request);
        return $merchant;
    }
