    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Create Data Packet</h6>
        ...
        <form method="POST" action="/dashboard/packet/insert"> 
             @csrf
                    ...
                    <div class="form-group">
                         <label for="packet_name" class="form-label">Nama Paket</label> 
                            <div class="form-control-wrap">
                                ...
                                name="packet_name" autocomplete="off"   autofocus  value="{{  old('packet_name') }}"> 
                                @error('packet_name') 
                    ...
                    <div class="form-group">
                        <label for="estimasi_time" class="form-label">Estimasi</label> 
                            <div class="form-control-wrap">
                                ...
                                name="estimasi_time" autocomplete="off" placeholder="Ex : 2 hari sampai."   autofocus  value="{{  old('estimasi_time') }}"> 
                                @error('estimasi_time') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                       <label for="estimasi_time_days" class="form-label">Estimasi (Days)</label> 
                            <div class="form-control-wrap">
                                ...
                                name="estimasi_time_days" autocomplete="off" placeholder="Ex : 2."   autofocus  value="{{  old('estimasi_time_days') }}"> 
