    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">List Data Trasit Perwakilan Packet - {{ auth()->user()->merchant_id }}</h6>
        ...
        <div class="card-tools" >
            <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Revenue from subscription"></em>
              ...
              @endif
            <form method="POST" action="#" id="form-price-list"> 
  ...
  function getTablesData() {
    ...
    async function goValidate() {
       ...
       var id_packet =  $('#id_packet').val();
        ...
        $('#No_resi').focus();
          try{
            const dtGoTransitDataPacket= await GoTransitDataPackets(); 
