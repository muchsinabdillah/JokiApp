    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Create Data Pricelist</h6>
        ...
        <form method="POST" action="/dashboard/pricelist/insert" id="form-price-list"> 
                    ...
                    <div class="form-group">
                         <label for="name_provinces_start" class="form-label"> Provinsi Tujuan Awal <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control form-control-sm name_provinces_start" id="name_provinces_start" name="name_provinces_start" placeholder="Ketik Provinsi Tujuan Awal" autocomplete="off" >
                                <input type="hidden"  class="form-control form-control-sm" id="id_provinces_start" name="id_provinces_start" placeholder="Ketik Provinsi">
                            </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="name_regencies_start" class="form-label">Kab/Kota Tujuan Awal <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                                <input autocomplete="off" type="text" class="form-control form-control-sm name_regencies_start"  id="name_regencies_start" name="name_regencies_start" placeholder="Ketik Kabupaten Tujuan Awal">
                                <input type="hidden" class="form-control form-control-sm " id="id_regencies_start" name="id_regencies_start" placeholder="Kabupaten Akhir">
                            </div>
                    </div>
                </div>      
                <div class="col-lg-6">
                    <div class="form-group">
                       <label for="name_provinces_end" class="form-label">Provinsi Tujuan Akhir <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                                <input autocomplete="off" type="text" class="form-control form-control-sm name_provinces_end" id="name_provinces_end" name="name_provinces_end" placeholder="Ketik Provinsi Tujuan Akhir">
                                <input type="hidden"  class="form-control form-control-sm" id="id_provinces_end" name="id_provinces_end" placeholder="Ketik Provinsi">
                            </div>
                    </div>
                </div>     
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="name_regencies_end" class="form-label">Kab/Kota Tujuan Akhir <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                                <input autocomplete="off" type="text" class="form-control form-control-sm name_regencies_end"  id="name_regencies_end" name="name_regencies_end" placeholder="Ketik Kabupaten Tujuan Akhir">
                                <input type="hidden" class="form-control form-control-sm id_regencies_end" id="id_regencies_end" name="id_regencies_end" placeholder="Kabupaten Akhir">
                            </div>
                    </div>
                </div> 
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                         <label for="price" class="form-label">Nilai Tarif <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                                <input type="text" autocomplete="off" class="form-control form-control-sm price" id="price" name="price" placeholder="Ketik Nilai tarif"> 
                            </div>
                    </div>
                </div> 
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="price_asuransi" class="form-label">Asuransi <span aria-hidden="true" role="presentation" class="field_required" style="color:#ee0000;">*</span></label>
                            <div class="form-control-wrap">
                               <input type="text" autocomplete="off" class="form-control form-control-sm" id="price_asuransi" name="price_asuransi" placeholder="Ketik Nilai Asuransi"> 
                            </div>
                    </div>
                </div> 
                <div class="col-lg-6">
        ...
        e.preventDefault();
         swal({
            ...
            .then((willDelete) => {
                ...
                $.ajax({
                    type: "POST",
                    url: "/dashboard/pricelist/insert",
