    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Create Data Merchasnt</h6>
        ...
        <form  method="POST" action="/dashboard/merchant/insert"> 
             @csrf
                    ...
                    <div class="form-group">
                        <label for="merchant_name" class="form-label">Nama Mitra</label> 
                            <div class="form-control-wrap">
                                ...
                                name="merchant_name" autocomplete="off"   autofocus  value="{{  old('merchant_name') }}"> 
                                @error('merchant_name') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="phone_number" class="form-label">No. Handphone</label>
                            <div class="form-control-wrap">
                                <input type="number"   class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" autocomplete="off"   value="{{  old('phone_number') }}"> 
                                @error('phone_number') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                         <label for="merchant_person" class="form-label">Merchant Person</label>
                            <div class="form-control-wrap">
                               <input type="text"   class="form-control @error('merchant_person') is-invalid @enderror" id="merchant_person" name="merchant_person" autocomplete="off"   value="{{  old('merchant_person') }}"> 
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="name_regencies" class="form-label">Kabupaten Name</label>
                            <div class="form-control-wrap">
                               <input type="text"   class="typeahead form-control @error('name_regencies') is-invalid @enderror" id="name_regencies" name="name_regencies" autocomplete="off"   value="{{  old('name_regencies') }}"> 
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="id_regencies" class="form-label">Kabupaten ID</label>
                            <div class="form-control-wrap">
                               <input type="text"  readonly class="form-control @error('id_regencies') is-invalid @enderror" id="id_regencies" name="id_regencies" autocomplete="off"   value="{{  old('id_regencies') }}"> 
                                @error('id_regencies') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
