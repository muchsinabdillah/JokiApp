    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Data Merchant</h6>
              <p>In last 30 days revenue from subscription.</p>
              <a href="/dashboard/merchant/create" class="btn btn-primary"><em class="icon ni ni-setting"></em><span>New</span></a>
        </div>
                    ...
                    <tbody>
                      @foreach ($posts as $post)
                          <tr>
                              ...
                              <td>{{  $post->status }}</td>
                              <td>
                                  <a href="/dashboard/merchant/view/{{ $post->id }}" class="btn btn-sm btn-info"><i class="icon bi bi-eye"></i></a> 
                              </td> 
                          </tr>
                      @endforeach
                    </tbody>
