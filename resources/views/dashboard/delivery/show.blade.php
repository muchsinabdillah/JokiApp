      ...
      <div class="card-title-group align-start mb-2">
        ...
        <div class="card-tools">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="form-group"> 
                        <form action="dashboard/delivery/delete" method="post" id="form-delivery-transaction">
             ...
             <div class="btn-group"> 
                 <button type="submit" class="btn btn-danger mt-3"><i class="icon bi bi-file-earmark-plus"></i><span>Delete</span></button>
